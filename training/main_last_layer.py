...
def main(args):
    ...
    if args.resume:
        if args.model.startswith('MedViT'):
            ...
            raise NotImplementedError("Only MedViT model --resume is supported for now.")
        ...
        if not args.finetune:
            if args.model.startswith('MedViT'):
                ...
                raise NotImplementedError("Only MedViT model full training is supported for now.")
    ...
    if args.eval: 
        ...
        #    pickle.dump(model.module, f, pickle.HIGHEST_PROTOCOL)
